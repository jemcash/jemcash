...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units jemtoshis-per-kilobyte.
        ...
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 jemtoshis.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in jemtoshis)
        // i.e. 182 * 3 = 546 jemtoshis with default -minrelaytxfee = minRelayTxFee = 1000 jemtoshis per kB.
