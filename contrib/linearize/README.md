# Linearize
Construct a linear, no-fork, best version of the Jemcash blockchain. The scripts
...
JSON-RPC server. Running `jemcashd` or `jemcash-qt -server` will be sufficient.
...
* `input`: jemcashd blocks/ directory containing blkNNNNN.dat
