# Contents
This directory contains tools to automatically get data about the memory consumption by some objects in jemcashd process with the help of GDB debugger.
