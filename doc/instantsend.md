...
This mechanism has been integrated into Bitcore-Node-Jemcash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/jempay/insight-api-jemcash#web-socket-api](https://github.com/jempay/insight-api-jemcash#web-socket-api)
* API: [https://github.com/jempay/insight-api-jemcash#instantsend-transactions](https://github.com/jempay/insight-api-jemcash#instantsend-transactions)
...
By default, the Jemcash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Jemcash Core daemon:
