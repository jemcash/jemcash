...
Below are some notes on how to build Jemcash Core for Windows.
...
way. This will install to `c:\workspace\jemcash`, for example:

    make install DESTDIR=/mnt/c/workspace/jemcash
