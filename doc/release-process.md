...
space *do not upload these to the jempay.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the jempay.org server

- Update jempay.org

- Announce the release:

  - Release on Jemcash forum: https://www.jempay.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Jempay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~jempay.org/+archive/ubuntu/jemcash)
