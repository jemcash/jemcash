...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid jemcash address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid jemcash address" in e.error['message'])
